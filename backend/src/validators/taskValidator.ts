...
export const createValidator = [
  body('title').not().isEmpty().withMessage('The task title mandatory')
  .trim().isString().withMessage('Title needs to be in text format'),

  body('date').not().isEmpty().withMessage('The task date is mandatory')
  ...
  body('status').trim().isIn([Status.todo, Status.inProgress, Status.completed,])
